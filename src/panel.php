                ...
                <section class="w-[98%] h-[88%] mx-4 2xl:h-[88.5%] flex justify-center items-center">
                    <ul class="list-none w-[100%] h-[90%] gap-12 flex flex-row justify-start items-center" id="card-container">
                        <li class="bg-[#e9e9e9] w-[25%] min-w-[150px] 2xl:min-w-[420px] h-[100%] flex justify-center flex-col items-center rounded-md shadow-md">
                            <div class="w-full bg-[#202125] h-[13%] rounded-t-md flex justify-center items-center">
                                <input type="text" class="text-center font-light font-sans text-[#ffffff] text-2xl 2xl:text-2xl transition-all duration-500 bg-transparent border-b-[1px] outline-none w-[35%] hover:w-[55%]" placeholder="Carta" value="Carta 1">
                            </div>
                            ...
                            <ul class="my-4 w-full list-none h-[100%] gap-4 flex flex-col items-center overflow-y-scroll">
                                ...
                                <li class="bg-[#202125] hover:w-[20%] transition-all duration-700 w-[15%] min-h-[30px] rounded-xl flex justify-center items-center text-center">
                                    <button class="text-3xl w-full h-full text-white hover:text-[#a8a8a8] font-thin text-center flex justify-center items-center transition-all duration-700 hover:rotate-12">+</button>
                                </li>
                            </ul>
                        </li>

                        <li class="bg-[#202125] w-[3.8%] h-[6.8%] flex justify-center flex-col items-center rounded-md shadow-md">
